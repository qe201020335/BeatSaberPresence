...
internal class MultiplayerPresenceManager : IInitializable, ILateDisposable
{
    ...
    internal MultiplayerPresenceManager([InjectOptional] IGamePause gamePause, PluginConfig pluginConfig,
        PresenceController presenceController, AudioTimeSyncController audioTimeSyncController,
    ...
    private Activity RebuildActivity(bool paused = false)
    {
        ...
        /*if (pluginConfig.AllowMultiplayerJoin && !multiplayerRichPresenceData.atMaxPartySize && multiplayerRichPresenceData.isJoinable) { // for later use :)
            activity.Secrets = new ActivitySecrets {
                Join = multiplayerRichPresenceData.multiplayerSecret
            };
        }*/
